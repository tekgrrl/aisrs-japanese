...
export function parseVocabLessonBody(markdown: string): Partial<VocabLesson> {
  ...
  const definitionsText =
    ...
    extractSection(markdown, "Definitions"); // "Reference" is sometimes used for definitions in older content? Or maybe "Definitions"
