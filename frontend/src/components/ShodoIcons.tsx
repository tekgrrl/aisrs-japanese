...
export const IconSumisuri = ({ className = "w-12 h-12" }: IconProps) => (
  ...
  >
    ...
    />
    <path
      d="M25 20H75V60C75 75 65 80 50 80C35 80 25 75 25 60V20Z"
      fill="black"
      fillOpacity="0.3"
    />
    <path
      d="M30 30Q40 25 60 28"
      stroke="white"
      strokeWidth="2"
      strokeOpacity="0.2"
      strokeLinecap="round"
...
export const IconGyosho = ({ className = "w-12 h-12" }: IconProps) => (
  ...
  >
    <path
      d="M48 15 C48 25, 52 25, 20 35 L80 35"
      stroke="currentColor"
      strokeWidth="5"
      strokeLinecap="round"
...
export const IconNijimi = ({ className = "w-12 h-12" }: IconProps) => (
  ...
  >
    <path
      d="M50 20C65 20 75 35 70 50C80 60 75 80 50 80C30 80 20 65 30 50C15 40 30 20 50 20Z"
      fill="currentColor"
      className="opacity-80 blur-[1px]"
    />
    <path
      d="M50 30C60 30 65 40 60 50C65 55 60 70 50 70C40 70 35 55 40 50C35 40 40 30 50 30Z"
      fill="currentColor"
    />
  </svg>
);
...
export const IconInkDrop = ({ className = "w-12 h-12" }: IconProps) => (
  ...
  >
    <path
      d="M50 15C50 15 20 45 20 65C20 81.5 33.5 95 50 95C66.5 95 80 81.5 80 65C80 45 50 15 50 15Z"
      fill="currentColor"
      className="opacity-90"
    />
    <path
      d="M35 60Q40 50 55 55"
      stroke="white"
      strokeWidth="3"
      strokeLinecap="round"
